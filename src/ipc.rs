...
pub use protocol::{
    ...
    ProtocolCommand, ProtocolError, ProtocolRequest, ProtocolResponse, ProtocolResult,
    ProtocolValidationError, ResponseStatus,
};
...
pub const SUPPORTED_VERSIONS: &[u16] = &[PROTOCOL_VERSION, LEGACY_PROTOCOL_VERSION];
